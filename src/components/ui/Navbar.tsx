...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-40 px-6 py-4 flex items-center justify-between pointer-events-none select-none">
        {/* Logo */}
        <a
          href="#hero"
        ...
        >
          ...
          <span className="hidden sm:inline-block text-[9px] font-mono tracking-widest text-technical-muted uppercase border border-void-700 px-1.5 py-0.5 rounded-sm">
            3D ARCHIVE
          </span>
        </a>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-6">
              ...
              <div className="pt-8 border-t border-void-800 flex items-center justify-between text-xs font-mono text-technical-muted">
                <span>dYnex? © 2026</span>
                <span className="text-signal-red">SIGNAL // ACTIVE</span>
              </div>
            </div>
          </motion.div>
        )}
